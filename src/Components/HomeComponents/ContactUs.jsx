...
function ContactUs() {
    return (
        <section id='contactUs' className="mx-10">
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div>
                        <span className="inline-block p-3 text-green-500 rounded-full bg-green-100/80">
                            <svg
                        ...
                        <p className="mt-2 text-green-500">customer_care@wevolve.com</p>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-green-500">EM-4/1 Sector V Bidhannagar KOL 700091 IND</p>
                    </div>
